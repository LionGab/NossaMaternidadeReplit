...
if (onlyA.length) console.error('  In .claude/mcp-config.json but not .mcp.json:', onlyA.join(', '));
if (onlyB.length) console.error('  In .mcp.json but not .claude/mcp-config.json:', onlyB.join(', '));
